...
## ユーザーの獲得について
会員登録不要でシャドーイングが体験できます。会員限定で視聴できる動画の種類を増やしたり、発音採点機能や単語保存機能を紹介し会員登録へ促す。
...
### 本リリース
- 発音点数ランキング
- 保存した単語の振り返り（暗記カードのように振り返りできる機能）
...
## ER図
[![Image from Gyazo](https://i.gyazo.com/db0d6944b96b8a43c3fcf0f3e52c0a89.png)](https://gyazo.com/db0d6944b96b8a43c3fcf0f3e52c0a89)